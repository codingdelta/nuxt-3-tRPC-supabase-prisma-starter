  ...
  <div>
                      ...
                      <ul role="list" class="-mx-2 space-y-1">
                        <li v-for="item in navigation" :key="item.name">
                          <NuxtLink
                            :to="item.to"
                            v-if="
                              useUserStore().roles.every((role) =>
                                item.roles.includes(role)
                              )
                            "
                            active-class="bg-gray-50 text-indigo-600 group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"
    ...
    <div class="lg:pl-72">
      ...
      >
        ...
        <UButton @click="logOut" class="ml-auto">Log out</UButton>
      </div>
...
const navigation = [
  { name: "Dashboard", to: "/", icon: HomeIcon, roles: ["admin", "user"] },
];
